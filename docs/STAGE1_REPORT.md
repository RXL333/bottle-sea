...
11. **测试**：52项，覆盖原有时钟、波浪、浮力、天气、移动、交互，以及过渡、焦点、入水、反馈、音频fallback、发现pulse、微动画、航迹寿命/容量/暂停、薄障碍竖直穿越和鼠标异常。
12. **typecheck**：通过。
13. **test**：22个文件、52项全部通过。
14. **build**：通过；JS649.98kB、gzip171.32kB，产物index-B7GuQZky.js。
