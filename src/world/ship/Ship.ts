...
export class Ship extends Group {
  ...
  constructor() {
    ...
    for(let row=0;row<3;row++) {
      b.add(['#493223','#6f482a','#98703e'][row],0,row*.09,0,.24+row*.13,.1,.72+row*.14);
    }
    ...
    for(let row=0;row<8;row++) {
      ...
      b.add(row%3?'#e7e1cf':'#cfcdb8',0,.46+row*.112,.075+width/2,.033,.116,width);
    }
    for(let row=0;row<6;row++) b.add('#e3dbbb',0,.48+row*.115,-.05-(.4-row*.045)/2,.035,.118,.4-row*.045);
